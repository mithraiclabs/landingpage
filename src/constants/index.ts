...
export const TOKEN_INFO_PAGE_SUB_HEADING = 'PsyOptions (PSY) is designed with the following principles in mind:'
...
export const FEES_DESCRIPTION_1 = 'The PsyOptions protocol will generate revenue from future fees through partner DOVs, and future trading protocols. Additionally, the PsyOptions protocol generates revenue through fees from volume traded on permissioned Serum markets.'
export const FEES_DESCRIPTION_2 = '  These fees are deposited into an address controlled by the governance protocol with which PSY tokens can make proposals and cast votes.'
...
export const PSY_INITIAL_LAUNCH_PRICE = 'PSY Initial Launch Price'
...
export const PSY_DESIGN_CARD_TOKENS_DESCRIPTION = 'The backbone of the PsyOptions ecosystem. Natively on Solana (SPL token), cross listed as ERC20.'
export const TRUSTLESS = 'Trustless'
export const PSY_OPTIONS = 'PsyOptions'
export const PSY_DESIGN_CARD_PSY_OPTIONS_DESCRIPTION = 'PsyOptions aims to become one of the foundational DeFi primitives on the Solana blockchain by offering completely trustless American style options for any SPL token.\n\n Providing this clearing house infrastructure to the Solana ecosystem will allow for increased composability between protocols, helping teams align incentives between themselves, their investors, their community members, and more.'
export const UTILITY = 'Utility'
export const PSY = 'PSY'
export const PSY_DESIGN_CARD_UTILITY_DESCRIPTION = ' is purely a governance token that manages the smart contracts, and treasury of tokens through on-chain voting. Proposals will be made on-chain, and voted on with the PSY token.'
export const STAKING = 'Staking'
export const PSY_DESIGN_CARD_STAKING_DESCRIPTION = 'There is currently no staking mechanism, however, this can change in the future through on-chain governance.'